...
): typeof updater extends undefined ? [T] : ReturnType<NonNullable<typeof updater>> {
    type RetState = typeof updater extends undefined ? [T] : ReturnType<NonNullable<typeof updater>>
